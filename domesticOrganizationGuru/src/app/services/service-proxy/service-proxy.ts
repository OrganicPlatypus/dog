...
export class Client {
    ...
    protected processCreateNotesPack(response: HttpResponseBase): Observable<string> {
        ...
        if (status === 200) {
            ...
            result422 = CreateNotesException.fromJS(resultData422);
...
export class CreateNotesException implements ICreateNotesException {
    targetSite?: MethodBase;
    readonly stackTrace?: string | undefined;
    readonly message?: string | undefined;
    readonly data?: { [key: string]: any; } | undefined;
    ...
    constructor(data?: ICreateNotesException) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.source = _data["source"];
            this.hResult = _data["hResult"];
            (<any>this).studentName = _data["studentName"];
        }
    }

    static fromJS(data: any): CreateNotesException {
        data = typeof data === 'object' ? data : {};
        let result = new CreateNotesException();
        result.init(data);
        return result;
    }
...
export interface ICreateNotesException {
    targetSite?: MethodBase;
    stackTrace?: string | undefined;
    message?: string | undefined;
    data?: { [key: string]: any; } | undefined;
